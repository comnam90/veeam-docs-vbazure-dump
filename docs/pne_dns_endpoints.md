...
1. [Locate private endpoints for your Veeam storage account in Microsoft Azure](pne_dns_endpoints_locate.md).
2. [Configure the private endpoint for Azure Blob Storage](pne_dns_endpoints_blobs.md).
3. [Configure private endpoint for Azure Queue Storage](pne_dns_endpoints_queues.md).
