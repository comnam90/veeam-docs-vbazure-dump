...
1. [Launch the Restore to Microsoft Azure SQL Wizard](restore_sql_wizard.md).
2. [Select a restore point](restore_sql_database.md).
3. [Choose a restore mode](restore_sql_mode.md).
4. [Specify target Azure SQL Server settings](restore_sql_server.md).
5. [Specify a new name for the restored database](restore_sql_name.md).
