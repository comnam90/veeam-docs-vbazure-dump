...
1. [Launch the Virtual Network Restore wizard](entire_vnet_restore_wizard.md).
2. [Select a region and a restore point](entire_vnet_restore_point.md).
3. [Select a service account](entire_vnet_restore_account.md).
4. [Choose a restore mode](entire_vnet_restore_mode.md).
5. [Configure additional restore settings](entire_vnet_restore_zone_mapping.md).
