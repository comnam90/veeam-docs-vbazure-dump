...
To retrieve archived data, you can launch the data retrieval process either from the [Data Retrieval wizard](#retrieval) before you begin a restore operation, or directly from the [Restore Virtual Machines](vm_restore.md) and [Restore Disks](performing_disk_restore.md) wizards. When you retrieve archived data, you can choose one of the following priority options:
...
[![Retrieving VM Data Manually](images/launch_vm_data_retrieval.webp)](images/launch_vm_data_retrieval.webp "Retrieving VM Data Manually")
...
[![Retrieving Data Manually](images/data_retrieval_wizard.webp)](images/data_retrieval_wizard.webp "Retrieving Data Manually")
