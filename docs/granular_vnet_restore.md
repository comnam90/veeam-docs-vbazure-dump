...
1. [Launch the Virtual Network Restore wizard](granular_vnet_restore_wizard.md).
2. [Select](entire_vnet_restore_point.md) [a region, a restore point and items to restore](granular_vnet_restore_point.md).
3. [Select a service account](granular_vnet_restore_account.md).
