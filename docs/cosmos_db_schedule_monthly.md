---
title: "cosmos_db_schedule_monthly"
product: "vbazure"
doc_type: "guide"
source_url: "https://helpcenter.veeam.com/docs/vbazure/guide/cosmos_db_schedule_monthly.html"
...
If a restore point is older than the specified time limit, Veeam Backup for Microsoft Azure removes the restore point from the chain. For more information, see [Cosmos DB Backup Retention](cosmos_db_backup_retention.md).
...
[![Adding Backup Policy](images/cosmos_db_schedule_monthly.webp)](images/cosmos_db_schedule_monthly.webp "Adding Backup Policy")
