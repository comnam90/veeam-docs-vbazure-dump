...
| --- |
| Tip |
| The configuration actions you perform vary on the identity provider you use. This guide covers actions performed for Microsoft Entra ID only. If you need to obtain instructions for another identity provider, open a [support case](support_information.md). |
