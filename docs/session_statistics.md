...
| --- |
| Tip |
| If you want to specify the time period during which Veeam Backup for Microsoft Azure will keep session records in the configuration database, follow the instructions provided in section [Configuring Global Retention Settings](configuring_global_retention.md#sessions). |
