...
1. [Launch the Add SLA Template wizard](sla_wizard.md).
2. [Specify a template name and description](sla_name.md).
3. [Configure snapshot settings](sla_snapshot_settings.md).
4. [Configure backup settings](sla_backup_settings.md).
